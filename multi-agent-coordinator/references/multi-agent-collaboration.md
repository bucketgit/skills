...
2. Move it to `ready` once scope is clear.
3. The implementing agent runs `bgit board take STORY_ID`.
4. The implementing agent comments with the branch name.
5. The coordinator avoids assigning overlapping files to multiple agents unless
